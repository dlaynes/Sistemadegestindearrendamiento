  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="rounded-xl border border-border-subtle bg-card p-6 shadow-elev-xs">
          <div className="mb-2 flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-destructive-muted">
              <AlertCircle className="h-5 w-5 text-destructive" />
            </div>
            <span className="text-sm font-medium text-muted-foreground">Vencido</span>
          </div>
          <p className="text-h2 font-semibold text-foreground">${totalOverdue.toLocaleString()}</p>
        </div>
      </div>
